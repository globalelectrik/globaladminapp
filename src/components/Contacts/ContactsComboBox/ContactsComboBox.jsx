...
export default function ContactsComboBox({ contacts, contactSelected, setContactSelected }) {
  const [query, setQuery] = useState('');


  return (
    <Combobox as='div' value={contactSelected} onChange={setContactSelected}>
			<div className='relative mt-2'>
				<ComboboxInput
					...
					displayValue={(contact) => contact?.contactName}
