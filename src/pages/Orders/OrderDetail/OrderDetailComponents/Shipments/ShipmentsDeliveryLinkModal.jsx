...
export default function ShipmentsDeliveryLinkModal({ openDeliveryLinkModal, setOpenDeliveryLinkModal, downloadDeliveryLink,setDownloadDeliveryLink }) {
  

  return (
    <div>
      <Dialog open={openDeliveryLinkModal} onClose={setOpenDeliveryLinkModal} className="relative z-10">
        <DialogBackdrop
          transition
            ...
            >
              ...
              <div>
                  ...
                  <div className="mt-3 text-center sm:mt-5">
                    ...
                    <div className="mt-2">
                      ...
                      <p className="text-sm text-gray-500 dark:text-gray-400">
                        Descarga el albarán dando click en el botón "Descargar Albarán"
                      </p>
                      <div className="mt-2">
                      
                      <p className="text-sm text-gray-500 dark:text-gray-400">
                        Enlace: {downloadDeliveryLink}
                      </p>
                      {downloadDeliveryLink ? (<LinkIcon
                        onClick={() => {
                          if (downloadDeliveryLink) {
                            navigator.clipboard.writeText(downloadDeliveryLink);
                ...
                <div className="mt-5 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3">
                  <a
                    href={downloadDeliveryLink}
                    target="_blank" 
                    rel="noopener noreferrer" 
                    onClick={() => setOpenDeliveryLinkModal(false)}
                  ...
                  <button
                    ...
                    data-autofocus
                    onClick={() => {
                      setOpenDeliveryLinkModal(false); 
                      setDownloadDeliveryLink(null)}
                      }
